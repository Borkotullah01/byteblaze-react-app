...
const Hero = () => {
    return (
    <div className="hero min-h-[calc(100vh-266px)]">
      <div className="hero-content text-center">
        <div className="max-w-xl">
          <h1 className="text-5xl font-bold">
            Welcome to 
            <span className="ml-3 bg-300% text-5xl font-bold bg-gradient-to-r from-blue-800 via-blue-500 to-fuchsia-600 text-transparent bg-clip-text animate-gradient">
            ByteBlaze
            </span>
            </h1>
